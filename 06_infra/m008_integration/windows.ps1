# Native M008-S02 preparation adapter. Explicit local configuration; no global environment changes.
[CmdletBinding()]
...
function Invoke-M008Native {
    ...
    try {
        ...
        $worker=Join-Path $settings.snapshot '06_infra/m008_integration/worker.py'
