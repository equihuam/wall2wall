...
Contrato de D010–D012. La aceptación y los presupuestos pertenecen al roadmap.
Este documento describe salidas futuras, no un workflow ejecutable ya construido.

## Entorno único de proyecto

Micromamba gestionará el entorno dedicado Python 3.11 en Linux x86-64 (linux-64),
dentro de WSL2 o en un equipo Linux nativo. Identificar distribución, arquitectura,
Micromamba y prefijo antes de ejecutar; no se presume que estén instalados.
Todos los procesos, incluido Git y los scripts de plantilla, deben ejecutarse en
Linux. Guardar el intérprete Linux sólo en project.local.toml ignorado. No reutilizar
paquetes, prefijos ni Python de Windows. ENVIRONMENT.md define el procedimiento.

Mantener en 06_infra/ una declaración portable environment.yml (Python 3.11,
...
En producción no crear entornos Micromamba por regla: lanzar Snakemake desde el entorno
...
usan script/subprocess con argv e intérprete Linux explícitos. Bash es el shell de
operación; no usar PowerShell, ejecutables .exe ni puentes a Python de Windows.
...
Registrar plataforma, librerías nativas, threads y límites numéricos. Micromamba/Snakemake
